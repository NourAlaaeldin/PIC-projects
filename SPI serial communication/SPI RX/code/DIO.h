...
/**
 * \b Brief: This is a function to select certain port of ports (A,B,C,D,E) to set the value (LOW , HIGH)
 * @param port uint8 port to select port
 * @param  value uint8 value to select value 
 * @return void 
 */
...
/**
 * \b Brief: This is a function to select certain port of ports (A,B,C,D,E) to set the value (any value)
 * @param port uint8 port to select port
 * @param  value uint8 value to select value 
 * @return void 
 */
